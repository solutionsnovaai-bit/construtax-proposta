...
function initTypewriter() {
  ...
  var pauseMs = 1400;   // pausa com nome completo
  var typeSpeed = 100;  // velocidade digitando
  var deleteSpeed = 60; // velocidade apagando
  ...
  function tick() {
    ...
    if (!isDeleting) {
      ...
      if (charIdx === current.length) {
        // nome completo — pausa antes de apagar
        isDeleting = true;
